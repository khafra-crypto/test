...
requirements = python3,kivy==2.2.0,kivymd==1.2.0,arabic-reshaper==2.1.3,python-bidi==0.4.2,pandas==1.0.1,pillow==11.2.1,filetype==1.2.0,six,future,materialyoucolor,exceptiongroup,asyncgui,asynckivy
